...
import { Button, Grid, Checkbox, Form, Input, Label, Segment, Icon, Menu, Dropdown, Modal, Message, Header, TextArea} from 'semantic-ui-react';
...
import {getSingle, getShowOrHideDomStyle, getLanguageTextByTaskType, setSemanticInputInitialledFocus, getLabelTextByMoments, copyToClipboard, sendMail} from '../js/tool.js';
...
class MultiFunctionBtn extends React.Component {
	...
	handleClickMailExportBtn() {
		...
		sendMail(mailValue, subject, "在此处粘贴数据");		
		console.log('导出成功');
	}
							...
							<Modal
						  		...
						  		size='small'>
						  		  ...
						  		  <Modal.Content>
	      	      	      		        <Form>
	      	      	      		        	<Form.Field>
	      	      	      		        	  <div style={getShowOrHideDomStyle(!showMailView)} >
